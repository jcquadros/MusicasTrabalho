libtads.a: tads/Musica.c tads/Vector.c tads/Artista.c tads/Menu.c tads/Musica.h tads/Vector.h tads/Artista.h tads/Menu.h
	...
	ar -crs libtads.a tads/Musica.o tads/Vector.o tads/Artista.o tads/Menu.o
